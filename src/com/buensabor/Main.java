...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("--- INICIANDO INSTANCIACIÓN Y RELACIÓN DE ENTIDADES PARA 'BUEN SABOR' ---");
        ...
        ArticuloManufacturado hamburguesaSimple = ArticuloManufacturado.builder()
                ...
                .descripcion("Clásica hamburguesa con lechuga, tomate y queso")
                .precioVenta(1200.0)
        ...
        System.out.println("\n--- País y Ubicación ---");
        System.out.println("País: " + paisArgentina.getNombre());
        ...
        System.out.println("Artículo Manufacturado: " + hamburguesaSimple.getDenominacion() + " (Precio Venta: $" + hamburguesaSimple.getPrecioVenta() + ")");
        ...
        System.out.println("\n--- Empresa y Sucursal ---");
        System.out.println("Empresa: " + empresaPrincipal.getNombre() + " (Razón Social: " + empresaPrincipal.getRazonSocial() + ")");
        ...
        System.out.println("\n--- Cliente y Usuario ---");
        System.out.println("Cliente: " + cliente1.getNombre() + " " + cliente1.getApellido() + " (Email: " + cliente1.getEmail() + ", Teléfono: " + cliente1.getTelefono() + ")");
        ...
        System.out.println("\n--- Promociones ---");
        System.out.println("Promoción: " + happyHourPizzas.getDenominacion() + " (" + happyHourPizzas.getDescripcionDescuento() + ")");
        System.out.println("Fecha de Promoción: " + happyHourPizzas.getFechaDesde() + " al " + happyHourPizzas.getFechaHasta());
        System.out.println("Horario de Promoción: " + happyHourPizzas.getHoraDesde() + " a " + happyHourPizzas.getHoraHasta());
        System.out.println("Artículos Manufacturados en promoción:");
        for (ArticuloManufacturado articulo : happyHourPizzas.getArticulosManufacturados()) {
            System.out.println("  - " + articulo.getDenominacion());
        }
        System.out.println("Artículos Insumos en promoción:");
        for (ArticuloInsumo insumo : happyHourPizzas.getArticulosInsumos()) {
            System.out.println("  - " + insumo.getDenominacion());
        }
        System.out.println("Sucursales con la promoción:");
        ...
        System.out.println("Tipo de Envío: " + pedido1.getTipoEnvio());
        ...
        System.out.println("  - Fecha de Facturación: " + factura1.getFechaFacturacion());
        ...
        System.out.println("\n--- FIN DE LA INSTANCIACIÓN Y RELACIÓN ---");
    }
}